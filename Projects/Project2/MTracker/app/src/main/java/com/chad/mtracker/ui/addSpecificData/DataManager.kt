...
class DataManager {
    fun getDataCustomizations(dataTypes: String?): DataTypeInformation {
        return when(dataTypes) {
            DataTypes.WEIGHT.value -> DataTypeInformation(title = "Weight", inputType = "number", specialInstructions = "Please enter your weight in whole pounds", firestoreID = "weight" )
            DataTypes.HEIGHT.value -> DataTypeInformation(title = "Height", inputType = "number", specialInstructions = "Please enter your height in inches", firestoreID = "height"  )
            DataTypes.ACTIVITY_LEVEL.value -> DataTypeInformation(title = "Activity Level", inputType = "number", specialInstructions = "Please enter your activity as a decimal between 1 and 2", firestoreID = "activity_level"  )
